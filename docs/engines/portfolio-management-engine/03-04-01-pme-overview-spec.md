...
**Version:** 11.6 (2026-09-16) — the v7 redesign makes PME **purely informational**: the veto/stance authority was erased; PME reports the portfolio's current state and the TAE setup executor consumes `safety_state` as its single soft entry gate.
