...
**Version:** 11.10 (2026-09-17) — v11: quantity-first defaults + ladder_roles. See docs/CHANGELOG.md for the canonical version history.
...
```json
{
  ...
  "l2": {
    "tf_weighting": { "mode": "proportional",
                      "weights": { "1s": 0.1, "3s": 0.1, "5s": 0.1, "15s": 0.1,
                                   "30s": 0.166, "1m": 0.166, "3m": 0.5, "5m": 0.5,
                                   "15m": 1.0, "1h": 1.0 },
                      "floor": 0.2, "ceil": 1.0 },
