...
The Market Data Layer produces candles for every ACTIVE duration of the 14-duration pool simultaneously (`1s`…`1d`). Each timeframe has its own independent aggregation buffer per symbol.
